...
namespace TestProject
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                int length = (int)MathHelper.Max(10, 25-5*playerScore);
                currentSquare = new Rectangle(
                    rand.Next(0, this.Window.ClientBounds.Width - 25),
                    rand.Next(0, this.Window.ClientBounds.Height - 25),length
                    , length);
            ...
            if ((mouse.LeftButton == ButtonState.Pressed) && currentSquare.Contains(mouse.X, mouse.Y))
            {
                ++playerScore;
                timeRemaining = 0.0f;
                TimePerSquare = MathHelper.Max(0.5f, TimePerSquare - 0.25f);
            }
